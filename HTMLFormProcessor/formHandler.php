<?php
//get the form data into varibles and display on the output

//get first name value from post name variable
...
//$programInfo = $_POST["program_info"];
//$programAdv = $_POST["program_adv"];
...
<body>
	...
	<section>
		...
		<p>
			Thank you for your interest in <?php echo $schoolName . ".<br>" ?>
			We have you listed a <?php echo $standing . " standing starting this fall.<br>" ?>
			You have declared <?php echo $program . " as your major.<br>" ?>
			Based upon your responses, we will provide the following information in our confirmation email to you at
			<?php echo $email . ".<br>" ?>
			<?php
			if (isset($_POST['checkboxes']) && !empty($_POST['checkboxes'])) {
				echo "You requested the following information:<br>";
				echo "<ul>";
				...
				echo "No additional information requested.<br>";
			}
			?>
